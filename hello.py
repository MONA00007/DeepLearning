...
# 残差块3
X = convolutional_block(X, 3, [256, 256, 1024])  # 16,16,1024
X = identity_block(X, 3, [256, 256, 1024])
# 残差块4
X = convolutional_block(X, 3, [512, 512, 2048])  # 8,8,2048
X = identity_block(X, 3, [512, 512, 2048])
X = identity_block(X, 3, [512, 512, 2048])
X = identity_block(X, 3, [512, 512, 2048])
X = identity_block(X, 3, [512, 512, 2048])
# 残差块5
X = convolutional_block(X, 3, [1024, 1024, 1024])
X = identity_block(X, 3, [1024, 1024, 1024])
X = identity_block(X, 3, [1024, 1024, 1024])
# 残差块6
