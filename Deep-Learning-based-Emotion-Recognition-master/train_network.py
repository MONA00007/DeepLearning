...
etiket = 'Deep-Learning-based-Emotion-Recognition-master/labels/dominance.csv'
frame_duration = 15
overlap = 0  # degisecek
batch_size = 64
num_classes = 2
...
# location read
results = []
with open("Deep-Learning-based-Emotion-Recognition-master/loc2d.csv") as csvfile:
...
# label read as array
# with open('Deep-Learning-based-Emotion-Recognition-master/labels/arousal.csv') as f:
...
opt = adam_v2.Adam(lr=0.001, decay=1e-6)
